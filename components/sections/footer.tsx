      ...
      <div className="container py-8 md:py-12 lg:py-16 px-4 md:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12 mb-6 md:mb-8 lg:mb-12">
          <div>
            ...
            >
              <WhatsAppIcon />
              <span className="text-sm">{content.footer.whatsappLabel}</span>
            </a>
          </div>

          {content.footer.sections.map((section, index) => (
            <div key={index}>
              <h4 className="font-bold text-base md:text-lg mb-4">{section.title}</h4>
        ...
        <div className="pt-6 md:pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-slate-400 text-xs md:text-sm">{content.footer.copyright}</p>
    ...
    <footer className="bg-slate-900/50 border-t border-slate-800">
      <div className="container py-12 md:py-16 px-6 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 px-6 py-3 md:px-8 md:py-4 bg-green-500 text-black font-semibold rounded-xl hover:bg-green-400 transition-all mb-6 md:mb-8 text-sm md:text-base"
        >
          <WhatsAppIcon />
...
export function FooterMinimal() {
  return (
    <footer className="border-t border-slate-800">
      <div className="container py-10 md:py-12 px-6">
        ...
        <p className="text-slate-400 text-xs md:text-sm text-center mt-6 md:hidden">{content.footer.copyright}</p>
      </div>
    </footer>
  );
}
